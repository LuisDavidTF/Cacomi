...
# Cacomi - Admin Panel Standards

Este skill define los lineamientos estrictos y seguros que deben seguirse al desarrollar cualquier característica del Panel de Administrador de Cacomi.
...
- **Diseño Premium**: Las gráficas deben respetar la paleta de colores de Cacomi (tailwind 4), soportar Dark/Light mode automáticos, y poseer tooltips interactivos y animaciones fluidas (ease-in-out).
