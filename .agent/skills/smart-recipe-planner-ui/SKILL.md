---
name: smart-recipe-planner-ui
description: >
  Utilícese para diseñar componentes visuales e interfaces en el proyecto Smart Recipe Planner.
  Trigger: When working inside ui/ on specific conventions (shadcn, folder placement, actions/adapters, shared types/hooks/lib).
license: Apache-2.0
metadata:
  author: ant-gravity
  version: "1.0"
  ...
  auto_invoke:
    ...
    - "Working on UI structure (actions/adapters/types/hooks)"
