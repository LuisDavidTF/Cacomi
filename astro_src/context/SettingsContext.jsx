...
export const translations = {
    es: {
        ...
        recommendedMenu: {
            ...
            addDayToPlan: 'Añadir este día al plan',
            addWeekToPlan: 'Añadir semana completa',
            daySuccess: 'Día añadido con éxito al planeador.',
            weekSuccess: 'Semana añadida con éxito al planeador.',
            deliveryOnlyOnDayWarning: 'Nota: Las comidas seleccionadas solo se entregarán el día establecido en el menú (ej. el desayuno de lunes solo se entrega el lunes).',
        },
        preorder: {
            title: 'Preventa de Comida Preparada',
            subtitle: 'Tu plan semanal cocinado por chefs profesionales y entregado en la puerta de tu hogar.',
            statusClosed: 'Preventa Cerrada',
            statusOpen: 'Preventa Abierta',
            statusNoticeClosed: 'Los pedidos de comida preparada se abren de miércoles a sábado para entregarse la siguiente semana.',
            statusNoticeOpen: 'Los pedidos están abiertos para la próxima semana. Tienes hasta el sábado a las 11:59 PM para ordenar.',
            distanceCheck: 'Verificación de Cobertura',
            inCoverage: 'Dentro del área de cobertura (cobertura válida)',
            outOfCoverage: 'Fuera del área de cobertura (máx. 15 km)',
            detectLocation: 'Detectar mi Ubicación',
            simulatedLocation: 'Simular Ubicación',
            mtyCentro: 'Monterrey Centro (Cerca - 2 km)',
            spgg: 'San Pedro Garza García (Cerca - 8 km)',
            santiago: 'Santiago, NL (Fuera - 35 km)',
            selectMeals: 'Selecciona tus platillos del Menú Recomendado',
            clearSelection: 'Limpiar selección',
            selectAll: 'Seleccionar todo el menú',
            deliveryDays: 'Días de entrega seleccionados',
            paymentPlan: 'Plan de Pago',
            payHalf: 'Pagar 50% de anticipo mínimo',
            payFull: 'Pagar 100% del total',
            pricePerMeal: 'Precio por comida',
            totalAmount: 'Monto total',
            depositAmount: 'Monto a pagar hoy',
            stripeCardDetails: 'Detalles de la Tarjeta (Stripe)',
            payButton: 'Realizar Pago Seguro',
            processing: 'Procesando pago seguro...',
            successTitle: '¡Pedido Confirmado!',
            successMessage: 'Tu pago ha sido procesado de forma segura a través de Stripe. Hemos registrado tu preventa para la próxima semana.',
            ticketDetails: 'Detalles del Ticket',
            ticketOrderNumber: 'Número de Orden',
            ticketTotalPaid: 'Monto Pagado Hoy',
            ticketRemaining: 'Monto Pendiente al Recibir',
            backToHome: 'Volver al Inicio',
            developerControls: 'Controles de Simulación (Desarrollo)',
        ...
        recipe: {
            ...
            retry: 'Reintentar Cargar',
            checkNet: 'Verifica tu conexión a internet o intenta recargar la página.',
    ...
    en: {
        ...
        recommendedMenu: {
            ...
            addDayToPlan: 'Add this day to plan',
            addWeekToPlan: 'Add entire week',
            daySuccess: 'Day successfully added to planner.',
            weekSuccess: 'Week successfully added to planner.',
            deliveryOnlyOnDayWarning: 'Note: Selected meals will only be delivered on their designated day (e.g., Monday breakfast is only delivered Monday morning).',
        },
        preorder: {
            title: 'Prepared Meals Pre-order',
            subtitle: 'Your weekly meal plan cooked by professional chefs and delivered right to your door.',
            statusClosed: 'Pre-orders Closed',
            statusOpen: 'Pre-orders Open',
            statusNoticeClosed: 'Pre-orders open from Wednesday to Saturday to be delivered the following week.',
            statusNoticeOpen: 'Pre-orders are open for next week. You have until Saturday at 11:59 PM to place your order.',
            distanceCheck: 'Coverage Verification',
            inCoverage: 'Within delivery area (valid coverage)',
            outOfCoverage: 'Outside delivery area (max. 15 km)',
            detectLocation: 'Detect my Location',
            simulatedLocation: 'Simulate Location',
            mtyCentro: 'Monterrey Downtown (Close - 2 km)',
            spgg: 'San Pedro (Close - 8 km)',
            santiago: 'Santiago, NL (Far - 35 km)',
            selectMeals: 'Select your meals from the Recommended Menu',
            clearSelection: 'Clear selection',
            selectAll: 'Select entire menu',
            deliveryDays: 'Selected delivery days',
            paymentPlan: 'Payment Plan',
            payHalf: 'Pay 50% minimum deposit',
            payFull: 'Pay 100% in full',
            pricePerMeal: 'Price per meal',
            totalAmount: 'Total amount',
            depositAmount: 'Amount to pay today',
            stripeCardDetails: 'Card Details (Stripe)',
            payButton: 'Process Secure Payment',
            processing: 'Processing secure payment...',
            successTitle: 'Order Confirmed!',
            successMessage: 'Your payment has been successfully processed via Stripe. Your pre-order is registered for next week.',
            ticketDetails: 'Ticket Details',
            ticketOrderNumber: 'Order Number',
            ticketTotalPaid: 'Amount Paid Today',
            ticketRemaining: 'Amount Due Upon Delivery',
            backToHome: 'Back to Home',
            developerControls: 'Simulation Panel (Developer)',
        ...
        recipe: {
            ...
            retry: 'Retry Loading',
            checkNet: 'Check your internet connection or try refreshing the page.',
    ...
    fr: {
        ...
        recommendedMenu: {
            title: 'Menu Recommandé',
            subtitle: 'Le menu que nous avons partagé aujourd\'hui sur nos réseaux. Essayez-le !',
            addToPlan: 'Ajouter à mon plan',
            viewInPlanner: 'Voir dans le planificateur',
            showMenu: 'Afficher le Menu Recommandé',
            hideMenu: 'Masquer le Menu',
            success: 'Menu ajouté avec succès ! Vous pouvez maintenant le voir dans votre planificateur.',
            addDayToPlan: 'Ajouter ce jour au plan',
            addWeekToPlan: 'Ajouter toute la semaine',
            daySuccess: 'Jour ajouté avec succès au planificateur.',
            weekSuccess: 'Semaine ajoutée avec succès au planificateur.',
            deliveryOnlyOnDayWarning: 'Note: Les repas sélectionnés ne seront livrés que le jour correspondant (ex: le petit-déjeuner du lundi n\'est livré que le lundi matin).',
        },
        preorder: {
            title: 'Pré-commande de Plats Préparés',
            subtitle: 'Votre plan de repas hebdomadaire préparé par des chefs professionnels et livré à votre porte.',
            statusClosed: 'Pré-commandes Fermées',
            statusOpen: 'Pré-commandes Ouvertes',
            statusNoticeClosed: 'Les pré-commandes sont ouvertes du mercredi au samedi pour être livrées la semaine suivante.',
            statusNoticeOpen: 'Les pré-commandes sont ouvertes pour la semaine prochaine. Vous avez jusqu\'à samedi à 23h59 pour commander.',
            distanceCheck: 'Vérification de la Couverture',
            inCoverage: 'Dans la zone de livraison (couverture valide)',
            outOfCoverage: 'Hors de la zone de livraison (max. 15 km)',
            detectLocation: 'Détecter ma Position',
            simulatedLocation: 'Simuler la Position',
            mtyCentro: 'Monterrey Centre (Proche - 2 km)',
            spgg: 'San Pedro (Proche - 8 km)',
            santiago: 'Santiago, NL (Éloigné - 35 km)',
            selectMeals: 'Sélectionnez vos plats dans le Menu Recommandé',
            clearSelection: 'Effacer la sélection',
            selectAll: 'Sélectionner tout le menu',
            deliveryDays: 'Jours de livraison sélectionnés',
            paymentPlan: 'Plan de Paiement',
            payHalf: 'Payer un acompte minimum de 50%',
            payFull: 'Payer 100% du total',
            pricePerMeal: 'Prix par repas',
            totalAmount: 'Montant total',
            depositAmount: 'Montant à payer aujourd\'hui',
            stripeCardDetails: 'Détails de la Carte (Stripe)',
            payButton: 'Procéder au Paiement Sécurisé',
            processing: 'Traitement du paiement...',
            successTitle: 'Commande Confirmée !',
            successMessage: 'Votre paiement a été traité avec succès via Stripe. Votre pré-commande est enregistrée pour la semaine prochaine.',
            ticketDetails: 'Détails du Ticket',
            ticketOrderNumber: 'Numéro de Commande',
            ticketTotalPaid: 'Montant Payé Aujourd\'hui',
            ticketRemaining: 'Montant Dû à la Livraison',
            backToHome: 'Retour à l\'Accueil',
            developerControls: 'Controles de Simulation (Développeur)',
        ...
        recipe: {
            ...
            checkNet: 'Vérifiez votre connexion internet ou essayez de rafraîchir la page.',
