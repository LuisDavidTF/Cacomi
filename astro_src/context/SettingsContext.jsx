...
export const translations = {
    es: {
        ...
        vida: {
            ...
            btnExplore: 'Explorar Vida',
            btnSubscribe: 'Suscribirse',
            featuredChapter: 'CAPÍTULO 01',
            featuredTitle: 'El minimalismo como un ritual diario.',
            discoverTitle: 'Descubre Relatos',
            discoverSubtitle: 'Explora las mejores ideas para una vida consciente.',
            tabSaved: 'Guardados',
            tabAll: 'Explorar Todo',
            tabRecipes: 'Recetas',
            tabPhilosophy: 'Filosofía',
            tabInteriors: 'Interiores',
            tabCommunity: 'Comunidad',
            readArticle: 'Leer artículo',
            viewRecipe: 'Ver receta',
            readTime: 'min',
            subscribeSuccess: '¡Gracias por suscribirte al boletín de Cacomi!',
            subscribePlaceholder: 'Tu correo electrónico'
        },
        origen: {
            title: 'Origen',
            subtitle: 'La nutrición y los insumos a tu medida.',
            desc: 'La conexión entre lo natural, lo puro y tu bienestar diario. Encuentra herramientas y soluciones diseñadas por profesionales.',
            preorderTitle: 'Comida Preparada (Preventa)',
            preorderDesc: 'Tu plan semanal cocinado por chefs profesionales y entregado en la puerta de tu hogar.',
            preorderBtn: 'Ordenar Comida',
            plannerTitle: 'Planificador Semanal',
            plannerDesc: 'Organiza tus comidas con inteligencia artificial y optimiza tu alimentación diaria.',
            plannerBtn: 'Abrir Planificador',
            pantryTitle: 'Mi Alacena Inteligente',
            pantryDesc: 'Laves el control de tus ingredientes, evita el desperdicio y genera recetas automáticas.',
            pantryBtn: 'Gestionar Alacena',
            rawIngredientsTitle: 'Ingredientes Crudos',
            rawIngredientsDesc: 'Insumos frescos de alta calidad seleccionados directamente de productores locales para tu cocina.',
            comingSoon: 'Próximamente'
        }
    },
    en: {
        ...
        vida: {
            heroTitle: 'Vida. Discover the art of curated living.',
            heroSubtitle: 'Explore a visual journal dedicated to the textures, rituals, and philosophies that define the Cacomi lifestyle.',
            btnExplore: 'Explore Vida',
            btnSubscribe: 'Subscribe',
            featuredChapter: 'CHAPTER 01',
            featuredTitle: 'Minimalism as a daily ritual.',
            discoverTitle: 'Discover Stories',
            discoverSubtitle: 'Explore the best ideas for a conscious life.',
            tabSaved: 'Saved',
            tabAll: 'Explore All',
            tabRecipes: 'Recipes',
            ...
            readTime: 'min',
            subscribeSuccess: 'Thank you for subscribing to the Cacomi newsletter!',
            subscribePlaceholder: 'Your email address'
        },
        origen: {
            title: 'Origen',
            subtitle: 'Nutrition and inputs tailored for you.',
            desc: 'The connection between the natural, the pure, and your daily well-being. Find tools and solutions designed by professionals.',
            preorderTitle: 'Prepared Meals (Preorder)',
            preorderDesc: 'Your weekly meal plan cooked by professional chefs and delivered right to your door.',
            preorderBtn: 'Order Meals',
            plannerTitle: 'Weekly Planner',
            plannerDesc: 'Organize your meals with artificial intelligence and optimize your daily nutrition.',
            plannerBtn: 'Open Planner',
            pantryTitle: 'My Smart Pantry',
            pantryDesc: 'Keep track of your ingredients, prevent waste, and generate recipes automatically.',
            pantryBtn: 'Manage Pantry',
            rawIngredientsTitle: 'Premium Raw Ingredients',
            rawIngredientsDesc: 'High-quality fresh ingredients sourced directly from local producers for your kitchen.',
            comingSoon: 'Coming Soon'
        }
    },
    fr: {
        ...
        vida: {
            heroTitle: 'Vida. Discover the art of curated living.',
            heroSubtitle: 'Explore a visual journal dedicated to the textures, rituals, and philosophies that define the Cacomi lifestyle.',
            btnExplore: 'Explorer Vida',
            btnSubscribe: 'S\'abonner',
            featuredChapter: 'CHAPITRE 01',
            featuredTitle: 'Le minimalisme comme rituel quotidien.',
            discoverTitle: 'Découvrir les Récits',
            discoverSubtitle: 'Explorez les meilleures idées pour une vie consciente.',
            tabSaved: 'Enregistré',
            tabAll: 'Tout Explorer',
            tabRecipes: 'Recettes',
            tabPhilosophy: 'Philosophie',
            tabInteriors: 'Intérieurs',
            tabCommunity: 'Communauté',
            readArticle: 'Lire l\'article',
            viewRecipe: 'Voir la recette',
            readTime: 'min',
            subscribeSuccess: 'Merci de vous être abonné à la newsletter Cacomi !',
            subscribePlaceholder: 'Votre adresse e-mail'
        },
        origen: {
            title: 'Origen',
            subtitle: 'La nutrition et les intrants sur mesure.',
            desc: 'La connexion entre le naturel, le pur et votre bien-être quotidien. Trouvez des outils et des solutions conçus par des professionnels.',
            preorderTitle: 'Repas Préparés (Précommande)',
            preorderDesc: 'Votre plan de repas hebdomadaire cuisiné par des chefs professionnels et livré à votre porte.',
            preorderBtn: 'Commander Repas',
            plannerTitle: 'Planificateur Hebdomadaire',
            plannerDesc: 'Organisez vos repas avec l\'intelligence artificielle et optimisez votre nutrition quotidienne.',
            plannerBtn: 'Ouvrir le Planificateur',
            pantryTitle: 'Mon Garde-Manger Intelligent',
            pantryDesc: 'Gérez vos ingrédients, évitez le gaspillage et générez des recettes automatiquement.',
            pantryBtn: 'Gérer le Garde-Manger',
            rawIngredientsTitle: 'Ingrédients de Qualité Supérieure',
            rawIngredientsDesc: 'Des ingrédients frais de haute qualité provenant directement de producteurs locaux pour votre cuisine.',
            comingSoon: 'Bientôt'
        }
    }
};
